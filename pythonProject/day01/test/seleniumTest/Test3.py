...
def main():
    ...
    # 用浏览器访问url
    a.get(
        "https://mooc1-1.chaoxing.com/mycourse/studentstudy?chapterId=165007921&courseId=215575849&clazzid=34620761&enc=328b1c3d379e9efc5c7e5bdd608148d1")
    ...
    for i in range(start, end):
        try:
            ...
            time.sleep(1)
            ccc.click()
            if ccc.find_element_by_tag_name("h4").find_elements_by_tag_name("span")[1].text == "":
                continue
            else:
